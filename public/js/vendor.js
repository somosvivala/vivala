...
$(function() {
    ...
    $(".like-btn-comentario").click(function(){
    	...
    	.done(function(data) {
            var msgQtdCurtidas,
                qtdLikes = data;
            $("#barra-comentario-"+idComentario+" .like-btn").addClass('liked');
    	    if(qtdLikes > 1)
...
>>>>>>> cc4340b280c5d11a06ba17893a1370df7ad45af2
