    ...
    <div class="col-sm-12 margin-t-1 margin-b-1">
      <div class="row">
        ...
        {!! Form::text('cpf', null, ['placeholder' => 'Ex: 123.456.789-88', 'class' => 'form-control']) !!}
    </div>
    ...
    <div class="col-sm-12 margin-t-1 margin-b-1">
      ...
      {!! Form::text("endereco_cep", null, ['id'=>'endereco_cep', 'class' => 'form-control busca-cep-ativo']) !!}
    ...
    <div class="col-xs-9  margin-b-1">
      ...
      {!! Form::text("endereco_localidade", null, ['id'=>'endereco_localidade', 'class' => 'form-control', 'disabled' => true]) !!}
    </div>
    ...
    <div class="col-xs-3 margin-b-1">
      ...
      {!! Form::text("endereco_uf", null, ['id'=>'endereco_uf', 'class' => 'form-control', 'disabled' => true]) !!}
    </div>
    ...
    <div class="col-sm-12 margin-t-1 margin-b-1">
      ...
      {!! Form::text("endereco_logradouro", null, ['id'=>'endereco_logradouro', 'class' => 'form-control', 'disabled' => true]) !!}
    </div>
    ...
    <div class="col-sm-12 margin-t-1 margin-b-1">
      ...
      {!! Form::text("endereco_bairro", null, ['id'=>'endereco_bairro', 'class' => 'form-control', 'disabled' => true]) !!}
    </div>
