...
<div class="fundo-cheio col-sm-12 text-justified">
    ...
    <div class="col-sm-12 padding-b-2">
        <div class="col-sm-6 text-center">
            <img id="lembrancas-1" src="img/financiamento-coletivo/quero-conectar/vivala_lembrancas-1.png" data-zoom-image="img/financiamento-coletivo/quero-conectar/vivala_lembrancas-1.png" width="300" height="300" alt="" title=""></img>
        </div>
        <div class="col-sm-6 text-center">
            <img id="lembrancas-2" src="img/financiamento-coletivo/quero-conectar/vivala_lembrancas-2.png" data-zoom-image="img/financiamento-coletivo/quero-conectar/vivala_lembrancas-2.png" width="300" height="300" alt="" title=""></img>
        </div>
    </div>
    <div class="col-sm-12 margin-b-2">
        <div class="col-sm-6 text-center">
            <img id="lembrancas-3" src="img/financiamento-coletivo/quero-conectar/vivala_lembrancas-3.png" data-zoom-image="img/financiamento-coletivo/quero-conectar/vivala_lembrancas-3.png" width="300" height="300" alt="" title=""></img>
        </div>
        <div class="col-sm-6 text-center">
            <img id="lembrancas-4" src="img/financiamento-coletivo/quero-conectar/vivala_lembrancas-4.png" data-zoom-image="img/financiamento-coletivo/quero-conectar/vivala_lembrancas-4.png" width="300" height="300" alt="" title=""></img>
        </div>
    </div>
</div>
@endsection
