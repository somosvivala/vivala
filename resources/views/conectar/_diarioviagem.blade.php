...
<div class="fundo-cheio col-sm-12 text-justified">
    ...
    <div class="row">
        <div class="col-sm-12 text-center padding-b-10">
            <img class="col-sm-12" id="diario-de-viagem-1" src="img/financiamento-coletivo/quero-conectar/vivala_diario-de-viagem-1.png" data-zoom-image="img/financiamento-coletivo/quero-conectar/vivala_diario-de-viagem-1.png" height="100%" alt="" title=""></img>
        </div>
        <div class="col-sm-12 text-center padding-b-10">
            <img class="col-sm-12" id="diario-de-viagem-2" src="img/financiamento-coletivo/quero-conectar/vivala_diario-de-viagem-2.png" data-zoom-image="img/financiamento-coletivo/quero-conectar/vivala_diario-de-viagem-2.png" height="100%" alt="" title=""></img>
        </div>
        <div class="col-sm-12 text-center padding-b-10">
            <img class="col-sm-12" id="diario-de-viagem-3" src="img/financiamento-coletivo/quero-conectar/vivala_diario-de-viagem-3.png" data-zoom-image="img/financiamento-coletivo/quero-conectar/vivala_diario-de-viagem-3.png" height="100%" alt="" title=""></img>
        </div>
        <div class="col-sm-12 text-center padding-b-10">
            <img class="col-sm-12" id="diario-de-viagem-4" src="img/financiamento-coletivo/quero-conectar/vivala_diario-de-viagem-4.png" data-zoom-image="img/financiamento-coletivo/quero-conectar/vivala_diario-de-viagem-4.png" height="100%" alt="" title=""></img>
        </div>
    </div>
</div>
@endsection
