...
<nav class="menu-lateral">
	<ul>
		...
		<li><a href="/avaliacoes" class="click-img-no-border desativado"><i class="fa fa-star"></i>{{ trans('global.lbl_review_') }}</a></li>
		<li><a href="/culturabrasileira" class="click-img-no-border desativado"><i class="fa fa-paint-brush"></i>{{ trans('global.lbl_brazilian_culture') }}</a></li>
		<li><a href="/perfilvoluntario" class="click-img-no-border desativado"><i class="fa fa-hand-paper-o"></i>{{ trans('global.lbl_volunteer_profile') }}</a></li>
	</ul>
</nav>
<h4 class="suave">{{ trans('global.lbl_connect_with_friends') }}</h4>
<nav class="menu-lateral">
	<ul>
		<li><a href="/chat" class="click-img-no-border desativado"><i class="fa fa-binoculars"></i>{{ trans('global.lbl_chat_with_friends') }}</a></li>
	</ul>
</nav>
