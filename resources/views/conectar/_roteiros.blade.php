...
<div class="fundo-cheio col-sm-12 text-justified">
    ...
    <div class="col-sm-12 margin-b-2">
        <div class="col-sm-6 text-center">
            <img id="roteiros-1" src="/img/financiamento-coletivo/quero-conectar/vivala_roteiros-1.png" data-zoom-image="/img/financiamento-coletivo/quero-conectar/vivala_roteiros-1.png" width="300" height="300" alt="" title=""></img>
        </div>
    </div>
</div>
@endsection
