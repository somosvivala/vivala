...
<div class="fundo-cheio col-sm-12 text-justified">
    ...
    <div class="col-sm-12 padding-b-2">
        <div class="col-sm-6 text-center">
            <img id="cultura-brasileira-1" src="img/financiamento-coletivo/quero-conectar/vivala_cultura-brasileira-1.png" data-zoom-image="img/financiamento-coletivo/quero-conectar/vivala_cultura-brasileira-1.png" width="300" height="300" alt="" title=""></img>
        </div>
        <div class="col-sm-6 text-center">
            <img id="cultura-brasileira-2" src="img/financiamento-coletivo/quero-conectar/vivala_cultura-brasileira-2.png" data-zoom-image="img/financiamento-coletivo/quero-conectar/vivala_cultura-brasileira-2.png" width="300" height="300" alt="" title=""></img>
        </div>
    </div>
    <div class="col-sm-12 margin-b-2">
        <div class="col-sm-6 text-center">
            <img id="cultura-brasileira-3" src="img/financiamento-coletivo/quero-conectar/vivala_cultura-brasileira-3.png" data-zoom-image="img/financiamento-coletivo/quero-conectar/vivala_cultura-brasileira-3.png" width="300" height="300" alt="" title=""></img>
        </div>
    </div>
</div>
@endsection
