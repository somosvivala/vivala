...
@section('content')
{{--<h4 class="suave">{{ trans('global.lbl_brazilian_culture') }}</h4>--}}
<div class="fundo-laranja-claro col-sm-12">
    <h3 class="font-bold-upper text-center texto-branco">{{ trans('global.lbl_brazilian_culture') }}</h3>
...
<div class="fundo-cheio col-sm-12 text-justified">
    ...
    <div class="row">
        <div class="col-sm-12 text-center padding-b-10">
            <img class="col-sm-12" id="cultura-brasileira-1" src="img/financiamento-coletivo/quero-conectar/vivala_cultura-brasileira-1.png" data-zoom-image="img/financiamento-coletivo/quero-conectar/vivala_cultura-brasileira-1.png" height="100%" alt="" title=""></img>
        </div>
        <div class="col-sm-12 text-center padding-b-10">
            <img class="col-sm-12" id="cultura-brasileira-2" src="img/financiamento-coletivo/quero-conectar/vivala_cultura-brasileira-2.png" data-zoom-image="img/financiamento-coletivo/quero-conectar/vivala_cultura-brasileira-2.png" height="100%" alt="" title=""></img>
        </div>
        <div class="col-sm-12 text-center padding-b-10">
            <img class="col-sm-12" id="cultura-brasileira-3" src="img/financiamento-coletivo/quero-conectar/vivala_cultura-brasileira-3.png" data-zoom-image="img/financiamento-coletivo/quero-conectar/vivala_cultura-brasileira-3.png" height="100%" alt="" title=""></img>
        </div>
    </div>
</div>
@endsection
