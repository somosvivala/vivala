...
<div class="fundo-cheio col-sm-12 text-justified">
    ...
    <div class="row">
        <div class="col-sm-12 text-center padding-b-10">
            <img class="col-sm-12" id="perfil_viajante-1" src="/img/financiamento-coletivo/quero-conectar/vivala_perfil_viajante-1.png" data-zoom-image="/img/financiamento-coletivo/quero-conectar/vivala_perfil_viajante-1.png" height="100%" alt="" title=""></img>
        </div>
    </div>
</div>
@endsection
