...
<div class="fundo-cheio col-sm-12 text-justified">
    ...
    <div class="col-sm-12 margin-b-1">
        ...
        <h4 class="text-center">Veja as telas que serão entregues com a ajuda do financiamento.</h4>
        <h4 class="text-center">Toda a estrutura do site está sendo criada com a ajuda de vocês</h4>
        <h3 class="text-center">Apoiadores</h3>
    </div>
    <div class="col-sm-12">
        <div class="col-sm-6 text-center">
            <a href="/img/financiamento-coletivo/quero-conectar/vivala_perfil_viajante-1.png" data-lightbox="perfil_viajante-1" data-title="Prévia - Perfil Viajante">
