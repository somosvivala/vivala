<h4 class="suave">Pacotes com os melhores destinos</h4>
<ul class="sugestoes sugestoes-pacotes">
    <li>
        <a href="#" class="click-img-no-border" data-toggle="modal" data-target="#rio-olimpiada">
            ...
            <span class="col-sm-12">Explore o Rio de Janeiro durante as Olimpíadas!</span>
    ...
    <li>
        <a href="#" class="click-img-no-border" data-toggle="modal" data-target="#fortaleza-verao">
            ...
            <span class="col-sm-12">Que tal curtir Fortaleza no verão?</span>
            <button class="suave" type="button">{{ trans('global.lbl_seemore') }}</button>
        </a>
    ...
    <li>
        <a href="#" class="click-img-no-border" data-toggle="modal" data-target="#recife-carnavel">
            ...
            <span class="col-sm-12">Encontre hotéis para o carnaval de rua em Recife!</span>
            <button class="suave" type="button">{{ trans('global.lbl_seemore') }}</button>
        </a>
        <div id="fortaleza-verao" class="modal fade " role="dialog">
            <div class="modal-dialog modal-lg">
