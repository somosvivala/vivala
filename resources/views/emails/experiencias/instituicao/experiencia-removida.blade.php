@extends('emails.experiencias._base-experiencias', [
  ...
  @section('email-experiencia-cabecalho')
    <?php
      ...
      através do email <strong><a href="mailto: <?php echo(env("VIVALA_LINK_EMAIL")) ?>" target="_top" style="text-decoration:none;"><?php echo(env("VIVALA_LINK_EMAIL")) ?></a></strong><br>
      ou pelo telefone <strong><a href="tel:<?php echo(env("VIVALA_LINK_TELEFONE_CONTATO2") ?>" target="_top" style="text-decoration:none;"><?php echo(env("VIVALA_LINK_TELEFONE_CONTATO2")) ?></a>';
    ?>
