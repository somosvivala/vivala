  ...
  @section('email-experiencia-cabecalho')
    <?php
      $expTextoBaixo =
        ...
        ou pelo telefone <strong><a href="tel:'. env("VIVALA_LINK_TELEFONE_CONTATO2") .'" target="_top" style="text-decoration:none; color:#CB171E;">'. env("VIVALA_LINK_TELEFONE_CONTATO2") .'</a>';
    ?>
