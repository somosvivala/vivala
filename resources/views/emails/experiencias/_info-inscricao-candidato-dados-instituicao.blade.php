  ...
  <div style="display:block; margin:0 auto; max-width:600px;">
    <table style="width: 100%; padding-bottom:0; margin-top:0px;">
      <tbody>
        ...
        <tr align="center">
          <td>
            <table style="padding:25px 15px 0px; background-color:#ECEBEB; border-radius:15px; min-height:170px; height:170px; max-height:170px; min-width:450px; width:450px; max-width:450px; margin:20px auto 0; overflow:hidden;">
              <tbody>
