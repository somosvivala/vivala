        ...
        <tr>
          <td>
            <table style="width: 100%; padding-bottom:0; margin-top:0;">
              <tbody>
                <tr>
                  <td style="padding:0px; margin:0px; margin-bottom:10px;">
                ...
                <tr>
                  <td width="50%" style="width:50%;">
                      <img src="{{ $Experiencia->FotoCapaUrlPublica }}" min-width="240px" width="auto" max-width="300px" min-height="300px" height="300px" max-height="300px" style="padding:0px; margin:0px;/>
                  </td>
                  <td width="50%" style="width:50%;">
                    <table>
                      <tbody>
