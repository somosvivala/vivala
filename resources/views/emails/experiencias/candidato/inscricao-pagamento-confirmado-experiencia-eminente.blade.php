@extends('emails.experiencias._base-experiencias', [
  ...
  @section('email-experiencia-cabecalho')
    @include('emails.experiencias._experiencias_img-cabecalho', [
      ...
      'expLinkImagem' => 'img/icones/png/laranja-info-vazio.png',
            ...
            <div style="display:block; margin:0 auto; max-width:600px;">
              <table style="width: 100%; padding-bottom:0; margin-top:20px;">
                <tbody>
                  ...
                  <tr align="center">
                    <td>
                      <img src="{{ asset('') }}" alt="{{ trans('global.lbl_info_') }}" title="{{ trans('global.lbl_info_') }}" min-width="99px" width="auto" max-width="600px" min-height="150px" height="150px" max-height="150px" style="margin-bottom:0px;"/>
                    </td>
                  </tr>
                  ...
                  <tr align="center">
                    <td>
                      <h1 style="font-family:'FuturaBT Bold', 'Trebuchet MS', Helvetica, Arial, sans-serif; font-size:20px; font-weight:bold; color:; margin-bottom:20px; line-height:40px;">
