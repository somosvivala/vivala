        ...
        <tr align="left">
          <td>
            ...
            <ul>
              ...
              <li style="font-family:'Avenir Roman', 'Trebuchet MS', Helvetica, Arial, sans-serif; font-size:14px; color:white; margin:0 auto; padding-bottom:15px;">
                Disponibilize telefones para contatos próximos, caso haja alguma emergência.
              </li>
              <li style="font-family:'Avenir Roman', 'Trebuchet MS', Helvetica, Arial, sans-serif; font-size:14px; color:white; margin:0 auto; padding-bottom:15px;">
                A sua experiência é a céu aberto? Garanta protetores solares e/ou capas de chuva!
              </li>
