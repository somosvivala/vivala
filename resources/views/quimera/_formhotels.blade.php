<form novalidate="novalidate" name="searchHotel" id="search1" class="searchbox-form form-hotels" action="" method="GET">

  <div class="row">
    <div id="contenedorTipoViaje" class="city-container col-md-12 margin-b-1 margin-t-2">
  ...
  <div class="row">
    <div id="contenedorQuartos" class="hotelDates-container margin-b-1 margin-t-1">
  ...
  <div id="passengersHotel" class="passengersHotel row">
    <div class="rooms-container col-md-6 margin-b-1 margin-t-1">
      <label for="roomsQty">{{ trans('global.quimera_travel_quantity_') }}</label>
        <select class="mostraQuartosHotel valid">
  ...
  <div class="row">
      <div class="ho-passengersContainer col-md-12 margin-b-1 margin-t-1">
          <ul class="passengersList col-md-6">
              {{-- Quatro quartos --}}
              @for ($i = 1; $i < 5; $i++)
              <li id="room{{ $i }}" class="qtd-quartos @if ($i > 1) soft-hide @endif" data-room-id="{{ $i }}">
                  <label class="room-label roomLabel margin-b-1">{{ trans('global.quimera_travel_room') }} {{ $i }}</label>
