	...
	<div id="tour-quiz" class="col-sm-12 pergunta quiz-4">
		...
		<ul class="row sugestoes sugestoes-quiz">
			...
			<li class="col-sm-4 col-md-2">
				...
				<button id='btn_seguir' type="submit" class='btn_seguir_viajante tour-quiz-step4' data-intro='{{ trans("tour.tour_quiz-4-step2") }}' data-step="2" data-id="{{ $Perfil->id }}">{{ trans('global.lbl_follow') }}</button>
		...
		<div class="col-sm-12 text-center tour-quiz-step4" data-intro='{{ trans("tour.tour_quiz-4-step3") }}' data-step="3">
