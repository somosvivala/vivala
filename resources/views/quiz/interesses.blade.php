...
<div id="tour-quiz" class="col-sm-12 pergunta quiz-1">
    <a class="absolute-top-right laranja tour-quiz-step1" data-intro='{{ trans("tour.tour_quiz-1-step8") }}' data-step="8" href="{{ url ('quiz/personalize')}}">{{ trans("global.lbl_step_skip") }}</a>
    <h2 class="tour-quiz-step1" data-intro='{{ trans("tour.tour_quiz-1-step2") }}' data-step="2">{{ trans("global.quiz_interests_yours") }}</h2>
    <h3 class="tour-quiz-step1" data-intro='{{ trans("tour.tour_quiz-1-step4") }}' data-step="4">{{ trans("global.quiz_interests_choose") }}</h3>
    @if(isset($interesses))
    ...
    <ul class="interesses col-sm-6 text-left">
      <div data-intro='{{ trans("tour.tour_quiz-1-step5") }}' data-step='5' class="row margin-t-3 tour-quiz-step1">
      ...
      <div data-intro='{{ trans("tour.tour_quiz-1-step6") }}' data-step='6' class="row margin-t-3 tour-quiz-step1">
    ...
    <div data-intro='{{ trans("tour.tour_quiz-1-step7") }}' data-step='7' class="col-sm-12 tour-quiz-step1">
