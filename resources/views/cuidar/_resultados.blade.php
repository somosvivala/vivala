...
@section('content')
{{-- <h4 class="suave">{{ trans('global.lbl_result_') }}</h4> --}}
<div class="fundo-laranja-claro col-sm-12">
    <h3 class="font-bold-upper text-center texto-branco">{{ trans('global.lbl_result_') }}</h3>
...
<div class="fundo-cheio col-sm-12 text-justified">
    ...
    <div class="row">
        <div class="col-sm-12 text-center padding-b-10">
            <img class="col-sm-12" id="resultados-1" src="/img/financiamento-coletivo/quero-cuidar/vivala_resultados-1.png" data-zoom-image="/img/financiamento-coletivo/quero-cuidar/vivala_resultados-1.png" height="100%" alt="" title=""></img>
        </div>
    </div>
</div>
@endsection
