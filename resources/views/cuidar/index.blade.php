...
<div id="tour-pilares" class="pilar-cuidar">
    <div class="foto-fundo foto-header tour-pilar-cuidar-step2" style="background-image:url('/img/querocuidar.png');">
    ...
    <div class="fundo-cheio col-sm-12 margin-b-2 margin-t-2 padding-b-2 tour-pilar-cuidar-step7">
    ...
    <div class="col-sm-12 text-center tour-pilar-cuidar-step8">
